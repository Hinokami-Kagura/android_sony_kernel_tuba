...
#define ELAN_FW_VER_CPT_GLASS       0x558F
#define ELAN_FW_VER_INX_NONAF_KD       0x55F3
...
static uint8_t file_fw_data_CPT_GLASS[] = {
  #include "VY36_Glass_FW558F_ID00BE_20160420.i" /* modify */
};
//add DP2 FW, end
...
static uint8_t file_fw_data_INX_nonAF_KD[] = {
  #include "VY36_INX_3260_55F3_00BF_20160329.i" /* modify */
};
//add 2nd source TP FW, end
...
// ELAN_FW_VER_CPT_GLASS       0x558F
// ELAN_FW_VER_INX_NONAF_KD       0x55F3
